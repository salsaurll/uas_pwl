...
<a class="btn btn-warning" href="<?php echo base_url() ?>cart/clear">Kosongkan Keranjang</a>

<a href="<?= base_url('invoice/cetak') ?>" class="btn btn-success" target="_blank">Cetak Invoice</a>
